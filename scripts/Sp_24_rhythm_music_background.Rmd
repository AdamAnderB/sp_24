...
write.csv(participant_removal, "data_ouputs/participant_removal.csv", row.names = FALSE)
write.csv(taskremoval_long, "taskremoval.csv", row.names = FALSE)
write.csv(cronbachs_alpha_df, "cronbach_alpha.csv", row.names = FALSE)
write.csv(dynamic_models, "dynamic_models.csv", row.names = FALSE)
```

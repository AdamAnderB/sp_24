...
\subsubsection{participants}
 The recruitment of \livedata{partrem}{starting_participants} participants was managed through Prolific (n=\livedata{partrem}{data_exp_142778-v2 .before}) \cite{Palan_2018} and in-person recruitment (n=\livedata{partrem}{data_exp_141883-v12 .before}). Not included in this, 22 participants were rejected from participant due to failing initial requirements (e.g., eight removed for failed headphone-check)\cite{milne_2021}. Of the \livedata{partrem}{starting_participants}participants who participated in the study, \numspell{\livedata{partrem}{removed_participants}} were removed for low accuracy scores. Three median absolute deviations (MAD) was used as the standard for removal to maximize retained participants \cite{Leys_2013}. Of these, \numspell{\livedata{taskrem}{particip_remove_lang.remove}} were removed for being below MAD range in the language tasks and \numspell{\livedata{taskrem}{rhythm_part.remove}} removed for low performance in auditory-motor integration task.  
